...
reading_interval = 0.01  # Time interval between readings
...
def read_angle():
    ...
    total_angle = round((total_rotations * 180 + current_angle - rest_position) % 360 , 2)  # Loop at every 360 degrees and round to 2 decimal places
